...
<svg width="200" height="200" style="stroke-width: 5;" out:fade>
    {#if toDraw}
    <polygon transition:draw="{{duration: 2000}}" points="5,100 100,195 195,100 100,5" style="stroke-width:8;stroke:#CC5500" fill-opacity="0"/>
    ...
    <path transition:draw="{{duration: 2000}}" stroke="none" d="M0 0h24v24H0z" fill="none"/> 
    <path transition:draw="{{duration: 2000}}" d="M6 20v-16l6 14l6 -14v16" /> 
    </svg> 
    {/if}
</svg> 
{/if}
