<svg width="100" height="50" style="stroke-width: 5;" viewBox="0 0 200 200">
    <polygon class="fill-gray-900 stroke-purple-800"points="5,100 100,195 195,100 100,5" style="stroke-width:8;" fill-opacity="1" fill="#292b2c"/>
